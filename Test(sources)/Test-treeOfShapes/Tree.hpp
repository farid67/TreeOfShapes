...
//            std::cout << "l'élément " << parent[i] << " n'a pas été trouvé" << std::endl;
    ...
    // pour chaque élément dont l'offset est différent de celles des noeuds canonique, on l'ajoute au noeud correspondant
    ...
    // gestion des offsets maintenant
    ...
    for (it = Tree_node->begin();it != Tree_node->end();it++)
    {
        ...
        {
            // le noeud est la racinde de l'arbre
            root = *it;
        }
